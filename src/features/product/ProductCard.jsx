...
const ProductCard = ({ product, discountPrice }) => { // Updated to accept `discountPrice` prop
    ...
    return (
        <div className='relative group' onClick={() => navigate(`/product/${product.id}`)}>
            ...
            {(discountPrice !== null && discountPrice !== product.price) && ( // Render the discount price badge only if there's a discountPrice
            ...
            <div>
                ...
                <div className='flex pt-4 justify-center items-center space-x-2'>
                    ...
                    {(discountPrice !== null && discountPrice !== product.price) ? ( // Render the discounted price if discountPrice is available
                        <>
