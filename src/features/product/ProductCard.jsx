...
const ProductCard = () => {
    return (
        <div className='relative group'>
            <div className=''>
                <img src="https://luxcomforts.com/wp-content/uploads/2023/05/274841_2-300x300.png" alt="card" />
            </div>
            ...
            <div>
                <p className='text-xs text-gray-500 text-center'>OUTDOOR ACCESSORIES-DECOR-GARDEN-GAMES</p>
                <p className="text-base font-light">“10 X 10” Brown, Wood Garden Planter – 2 Piece</p>
